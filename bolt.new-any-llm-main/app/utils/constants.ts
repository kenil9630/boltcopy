...
const staticModels: ModelInfo[] = [
  ...
  { name: 'bedrock-foundation-2024', label: 'Amazon Bedrock Foundation', provider: 'Bedrock' },
  { name: 'amazon.titan-text-express-v1', label: 'Titan Text Express v1', provider: 'Bedrock'},
  { name: 'anthropic.claude-v2', label: 'Claude v2', provider: 'Bedrock'},
  { name: 'anthropic.claude-3-sonnet-20240229-v1:0', label: 'Claude 3 Sonnet', provider: 'Bedrock'},
